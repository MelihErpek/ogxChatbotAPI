...
app.get("/coconut", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Coconut Curls"]];
...
app.get("/brazil", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Brazilian Keratin Smooth"]];
...
app.get("/coconutmiracle", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Coconut Miracle Oil"]];
...
app.get("/argan", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Argan Oil Of Morocco"]];
...
app.get("/coconutmilk", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Coconut Milk"]];
...
app.get("/apple", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Apple Cider Vinegar"]];
...
app.get("/charcoal", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Charcoal Detox"]];
...
app.get("/keratin", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Keratin Oil"]];
...
app.get("/purple", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Purple Toning"]];
...
app.get("/orchid", async (req, res) => {
  try {
    ...
    const ay = String(tarih.getMonth() + 1).padStart(2, "0");
    const yil = tarih.getFullYear();
    let data = [[gun + "." + ay + "." + yil, "Orchid Oil"]];
